...
import app.regate.domain.pagination.account.MontoRetenidoPagination
import kotlinx.coroutines.flow.Flow
import me.tatarka.inject.annotations.Inject

@Inject
class MontoRetenidoViewModel(
    private val accountRepository: AccountRepository
) : ViewModel(){
    val pagedList: Flow<PagingData<MontoRetenidoDto>> = Pager(PAGING_CONFIG){
        MontoRetenidoPagination(fetch = {page->
            accountRepository.getMontoRetenidoPagination(page)
        })
