...
//    navigateToCreateSala: (id: Long) -> Unit,
    ...
    navigateToSelectEstablecimiento:(Long)->Unit,
) -> Unit

@Inject
@Composable
fun GrupoSalas(
    viewModelFactory:(SavedStateHandle)-> GrupoSalasViewModel,
    @Assisted navigateUp: () -> Unit,
//    @Assisted navigateToCreateSala: (id: Long) -> Unit,
    @Assisted openAuthBottomSheet: () -> Unit,
    @Assisted navigateToSala: (Long) -> Unit,
    @Assisted navigateToSelectEstablecimiento: (Long) -> Unit
){
    GrupoSalas(
...
@Composable
internal fun GrupoSalas(
    viewModel: GrupoSalasViewModel,
    navigateUp: () -> Unit,
//    navigateToCreateSala: (id:Long) -> Unit,
    navigateToSala: (Long) -> Unit,
    navigateToSelectEstablecimiento: (Long) -> Unit,
