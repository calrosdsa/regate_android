...
public final class RoomChatDao_Impl extends RoomChatDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateWhenUserLeave;
  ...
  public RoomChatDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfChat = new EntityInsertionAdapter<Chat>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR IGNORE INTO `chat` (`id`,`photo`,`name`,`last_message`,`last_message_created`,`messages_count`,`type_chat`,`is_message_deleted`,`parent_id`,`is_user_out`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final int _tmp_2 = entity.is_user_out() ? 1 : 0;
        statement.bindLong(10, _tmp_2);
        final String _tmp_3 = DateTimeTypeConverters.INSTANCE.fromInstant(entity.getUpdated_at());
        if (_tmp_3 == null) {
    ...
    this.__updateAdapterOfChat = new EntityDeletionOrUpdateAdapter<Chat>(__db) {
      ...
      @NonNull
      public String createQuery() {
        return "UPDATE OR ABORT `chat` SET `id` = ?,`photo` = ?,`name` = ?,`last_message` = ?,`last_message_created` = ?,`messages_count` = ?,`type_chat` = ?,`is_message_deleted` = ?,`parent_id` = ?,`is_user_out` = ?,`updated_at` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfUpdateWhenUserLeave = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "update chat set is_user_out = 1 where id = ?";
        return _query;
      }
    };
    ...
    this.__upsertionAdapterOfChat = new EntityUpsertionAdapter<Chat>(new EntityInsertionAdapter<Chat>(__db) {
      ...
      @NonNull
      public String createQuery() {
        return "INSERT INTO `chat` (`id`,`photo`,`name`,`last_message`,`last_message_created`,`messages_count`,`type_chat`,`is_message_deleted`,`parent_id`,`is_user_out`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      @NonNull
      public String createQuery() {
        return "UPDATE `chat` SET `id` = ?,`photo` = ?,`name` = ?,`last_message` = ?,`last_message_created` = ?,`messages_count` = ?,`type_chat` = ?,`is_message_deleted` = ?,`parent_id` = ?,`is_user_out` = ?,`updated_at` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object updateWhenUserLeave(final long chatId,
      final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateWhenUserLeave.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __db.endTransaction();
          __preparedStmtOfUpdateWhenUserLeave.release(_stmt);
        }
      }
    }, continuation);
  }
    ...
    return new LimitOffsetPagingSource<Chat>(_statement, __db, "messages", "chat") {
      ...
      protected List<Chat> convertRows(@NonNull final Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
          ...
          final int _tmp_2;
          _tmp_2 = cursor.getInt(_cursorIndexOfIsUserOut);
          ...
          if (cursor.isNull(_cursorIndexOfUpdatedAt)) {
            ...
            _tmp_3 = cursor.getString(_cursorIndexOfUpdatedAt);
          }
          ...
          _item = new Chat(_tmpId,_tmpPhoto,_tmpName,_tmpLast_message,_tmpLast_message_created,_tmpMessages_count,_tmpType_chat,_tmpIs_message_deleted,_tmpParent_id,_tmpIs_user_out,_tmpUpdated_at);
          _result.add(_item);
        }
        return _result;
      }
      ...
      public Chat call() throws Exception {
        ...
        try {
          ...
          try {
            ...
            final int _cursorIndexOfIsUserOut = CursorUtil.getColumnIndexOrThrow(_cursor, "is_user_out");
            ...
            if (_cursor.moveToFirst()) {
              ...
              _result = new Chat(_tmpId,_tmpPhoto,_tmpName,_tmpLast_message,_tmpLast_message_created,_tmpMessages_count,_tmpType_chat,_tmpIs_message_deleted,_tmpParent_id,_tmpIs_user_out,_tmpUpdated_at);
            } else {
              _result = null;
            }
            __db.setTransactionSuccessful();
  ...
  @Override
  public Flow<Chat> observeChatByType(final long parentId, final int typeChat) {
    final String _sql = "select * from chat where parent_id = ? and type_chat = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, parentId);
    _argIndex = 2;
    _statement.bindLong(_argIndex, typeChat);
    return CoroutinesRoom.createFlow(__db, true, new String[] {"chat"}, new Callable<Chat>() {
      @Override
      @NonNull
      public Chat call() throws Exception {
  ...
  @Override
  public Object getChatByType(final long pId, final int typeChat,
