...
import app.regate.base.InvokeError
import app.regate.base.InvokeStarted
import app.regate.base.InvokeStatus
import app.regate.base.InvokeSuccess
...
//    logger: Logger? = null,
    uiMessageManager: UiMessageManager? = null,
): Unit = onEachStatus(counter,uiMessageManager).collect()


inline fun <reified T> ApiResult<T>.collectResult(){
    when(this){
        is ApiSuccess -> {}
        is ApiError -> {}
    }
