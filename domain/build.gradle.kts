...
//    api(projects.tasks.api)
    ...
    api(projects.data.repository.account)
    api(projects.data.repository.establecimiento)
    api(projects.data.repository.instalacion)
    api(projects.data.repository.reserva)
    api(projects.data.repository.sala)
